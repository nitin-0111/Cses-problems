...
using namespace std;
/*
1. convert the char path to
  int 
  a. all updatable location ==INF (non updatable =="#" and inital 'A' also) 
   b. non updatable with a less value (0  or  -INF);

2. same dfs is use for monsters walk and 'A' walk
  useing (more ==false inital for monster walk)

  ** in bfs walk;
     1. put front out ==loc , 
     2. check next move is possible or not
     ** in check 
        1. it is similar like dikjstra 
 3. bfs for 'A' and check is it reach boundary 
   if yes  
     retrace the path 
